...
public class Intro extends AppCompatActivity {
    ...
    private String[] title_array = {
        "Welcome To DTS VSGA", "Work Happen",
        "Tasks and assign"
    };
    private String[] description_array = {
        "What is going to happen tomorrow ?","Get Notified When Work Happens",
        "Task and assign them to colleagues."
    };
    private int[] about_images_array = {
            R.drawable.ic_eventlist,R.drawable.ic_superhero,
            R.drawable.ic_assign
    };
    private int[] bg_intro_array = {
            R.drawable.bg_red,R.drawable.bg_blue,
    ...
    private void initComponent(){
        ...
        btn_get_started.setOnClickListener(new View.OnClickListener(){
            ...
            Intent intent = new Intent(Intro.this, WelcomeBack.class);
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position){
            ...
            ((ImageView) view.findViewById(R.id.bg_intro)).setImageResource(bg_intro_array[position]);
